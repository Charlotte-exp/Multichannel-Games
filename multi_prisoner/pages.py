...
class Payment(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'final_payment': sum([p.total_payoff.to_real_world_currency(self.session) for p in me.in_all_rounds()]
...
class LeftHanging(Page):
    ...
    All four players on a group are affected by a dropout, even if play in pairs
    """
